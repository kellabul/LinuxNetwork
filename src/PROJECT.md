...
Сначала мы освобождаем ip-адрес командой `dhclient -r`, а затем запрашиваем новый той же командой, но без аргументов (на данном устройстве у нас только один сетевой интерфейс, поэтому указывать его дополнительно в качестве аргумента к команде не требуется).

...
Чтобы обратиться к приложению, работающему на localhost, IP должен входить в этот диапазон. Т.е. при IP, имеющим значения:
...
Возможные IP адреса шлюза (из перечисленных): 10.0.0.1, 10.10.0.2, 10.10.10.10, 10.10.1.255
